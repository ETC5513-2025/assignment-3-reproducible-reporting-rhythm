---
title: "Rhythm Report"
author: Pranav Sajeev, Melisa Melisa, Ibtesam Ifaz
format:
  html:
    toc: true
    toc-title: Contents
...
From the analysis we can see that the affected groups are ones with public exams. This may be due to the fact that the students in those classes require more personal attention that online classes may not be able to provide.
...
Perhaps use different models to reach solutions. More complex models may be able to find more connections between the variables.

maybe use a different set of variables.
